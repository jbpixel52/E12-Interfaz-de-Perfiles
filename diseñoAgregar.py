...
botonAgregar = tk.Button(master=seccion2, text = 'Agregar', bg='green', fg ='white', font = tkFont.Font(family='Roboto', size = 14))
botonAgregar.place(anchor = tk.CENTER, relx = 0.5, rely = 0.9)
