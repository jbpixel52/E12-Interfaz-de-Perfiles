...
Nombre1 = tk.Label(master=seccion2, bg='white', fg='black',
                   text='Moises Gana Obregon', font=tkFont.Font(family='Roboto', size=10))
Nombre1.place(anchor=tk.NW, relx=0.22, rely=0.1)
Fecha1 = tk.Label(master=seccion2, bg='white', fg='gray',
                  text='17/02/1994', font=tkFont.Font(family='Roboto', size=8))
...
Nombre2 = tk.Label(master=seccion2, bg='white', fg='black',
                   text='Moises Gana Obregon', font=tkFont.Font(family='Roboto', size=10))
Nombre2.place(anchor=tk.NW, relx=0.22, rely=0.23)
Fecha2 = tk.Label(master=seccion2, bg='white', fg='gray',
                  text='17/02/1994', font=tkFont.Font(family='Roboto', size=8))
...
Nombre3 = tk.Label(master=seccion2, bg='white', fg='black',
                   text='Moises Gana Obregon', font=tkFont.Font(family='Roboto', size=10))
Nombre3.place(anchor=tk.NW, relx=0.22, rely=0.36)
Fecha3 = tk.Label(master=seccion2, bg='white', fg='gray',
                  text='17/02/1994', font=tkFont.Font(family='Roboto', size=8))
